...
* Install Hazelcast Management Center (optional)

Download the latest Hazelcast ZIP from [hazelcast.org](hazelcast.org) and run following to start on **port 8090** [http://localhost:8090/mancenter](http://localhost:8090/mancenter).

```
java -jar mancenter-*version*.war 8090 mancenter
```

## About the Service

The service is just a simple hotel review REST service. It uses an in-memory database to store the data. You can also do with a relational database like MySQL or PostgreSQL. If your database connection properties work, you can call some REST endpoints defined in ```com.santagar.hotel.api.rest.hotelController``` on **port 8080**. (see below)
...
Location header: http://localhost:8090/api/v1/hotels/1
```

### Retrieve a paginated list of hotels

```
http://localhost:8080/api/v1/hotels?page=0&size=10
...
```
http://localhost:8080/v2/api-docs (Swagger API)
...
# Questions and Comments: santagar@gmail.com
