package com.santagar.hotel.test;

/**
 * Uses JsonPath: https://github.com/json-path/JsonPath, Hamcrest and MockMVC
 */

import com.fasterxml.jackson.databind.ObjectMapper;
import com.santagar.hotel.Application;
import com.santagar.hotel.api.rest.HotelController;
...
public class HotelControllerTest {
    ...
    private static final String RESOURCE_LOCATION_PATTERN = "http://localhost/api/v1/hotels/[0-9]+";
    ...
    public void shouldCreateRetrieveDelete() throws Exception {
        ...
        //CREATE
        MvcResult result = mvc.perform(post("/api/v1/hotels")
                .content(r1Json)
        ...
        //RETRIEVE
        mvc.perform(get("/api/v1/hotels/" + id)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
 ...
 */
    ...
    public void shouldCreateAndUpdateAndDelete() throws Exception {
        ...
        //UPDATE
        result = mvc.perform(put("/api/v1/hotels/" + id)
                .content(r2Json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent())
